...
// 🎲 INÍCIO INTELIGENTE: Se ninguém tiver a pedra do voto, começa pelo index 0 (Segurança contra travamentos)
function iniciarRodadaOficial(room, baralhoGerado, regraEscolhida) {
    ...
    let indexQuemComeca = 0; // Padrão de segurança caso a pedra não seja encontrada
