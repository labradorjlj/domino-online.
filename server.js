...
function iniciarRodadaOficial(room, baralhoGerado, grandfatherId) {
    ...
    // Se o primeiro a jogar for um Bot, inicia a inteligência dele
...
io.on('connection', (socket) => {
    ...
    socket.on('adicionarRobos', ({ roomId }) => {
        ...
        // CORREÇÃO AQUI: Agora chama a função correta passando o baralho e definindo o primeiro jogador humano como inicial
